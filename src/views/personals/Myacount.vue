<template>
  <div class="acounts">
    <div class="account01">
      <ul>
        <li :class="{active01:$route.path=='/personal'}">
          <router-link to="/personal">账号中心</router-link>
        </li>
        <li :class="{active01:$route.path=='/personal/myacount/password'}">
          <router-link to="/personal/myacount/password">修改密码</router-link>
        </li>
