                ...
                <li v-for="(item,index) in tabedata"
                  ...
                  <div class="list_one">
                    ...
                    <div class="c9"
                      ...
                      <router-link to="/trading/details3">查看详情</router-link>
                    </div>
                  </div>
                  <div class="list_two">
                    <p class="list01">
...
export default {
  ...
  methods: {
    ...
    xiangqing (item) {
      window.sessionStorage.setItem("particul3", JSON.stringify(item))
      this.$router.push({ path: "/trading/details3", query: { id: item.id } })
    },
  }
}
</script>
